...
EYE_TRAVEL_X = 42               # max horizontal stroke travel with gaze (px)
...
BROW_LIFT = 8                   # brows rise/lower with vertical gaze (px)
...
BROW_SIDE_LIFT = 7           # the brow on the looked-toward side rises (px, per unit gaze)
BLINK_REACH_X = 44             # horizontal reach of the >_< blink strokes (px) — long, flat
BLINK_REACH_Y = 14             # vertical half-height of the >_< blink strokes (px)
MOUTH_Y = 200
